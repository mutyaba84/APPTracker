...
import com.example.apptracker.Map.MapLoc;
...
public class MainScreen extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final ChildEventListener childEventListener = userInfo.addChildEventListener( new ChildEventListener() {
            @Override
